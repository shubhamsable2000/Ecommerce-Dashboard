...
const _IsomorphicClerk = class _IsomorphicClerk {
  constructor(options) {
    ...
    this.setSession = (session, beforeEmit) => {
      (0, import_deprecated.deprecated)("setSession", "Use `Clerk.setActive` instead");
    ...
    this.handleMagicLinkVerification = async (params) => {
      (0, import_deprecated.deprecated)("handleMagicLinkVerification", "Use `handleEmailLinkVerification` instead.");
  ...
  async loadClerkJS() {
    ...
    try {
      ...
      global.Clerk.sdkMetadata = this.options.sdkMetadata ?? { name: "@clerk/clerk-react", version: "4.28.1" };
