...
var import_deprecated6 = require("@clerk/shared/deprecated");
...
var OrganizationAPI = class extends AbstractAPI {
  ...
  async getPendingOrganizationInvitationList(params) {
    (0, import_deprecated2.deprecated)("getPendingOrganizationInvitationList", "Use `getOrganizationInvitationList` instead.");
    const { organizationId, limit, offset } = params;
    this.requireId(organizationId);
    return this.request({
      method: "GET",
...
var import_deprecated3 = require("@clerk/shared/deprecated");
...
var SMSMessageAPI = class extends AbstractAPI {
  ...
  async createSMSMessage(params) {
    (0, import_deprecated3.deprecated)(
...
(0, import_deprecated.deprecatedProperty)(ExternalAccount, "picture", "Use `imageUrl` instead.");
...
(0, import_deprecated.deprecatedProperty)(Organization, "logoUrl", "Use `imageUrl` instead.");
...
(0, import_deprecated.deprecatedProperty)(OrganizationMembershipPublicUserData, "profileImageUrl", "Use `imageUrl` instead.");
...
(0, import_deprecated.deprecatedProperty)(User, "profileImageUrl", "Use `imageUrl` instead.");
...
var withLegacyReturn = (cb) => async (...args) => {
  ...
  if (errors === null) {
    ...
    throw new import_error2.ClerkAPIResponseError(statusText || "", {
      data: errors,
      status: status || "",
      clerkTraceId
    });
...
function buildRequest(options) {
  const request = async (requestOptions) => {
    ...
    if (apiKey) {
      (0, import_deprecated.deprecated)("apiKey", "Use `secretKey` instead.");
    }
    if (httpOptions) {
      (0, import_deprecated.deprecated)(
        "httpOptions",
...
var import_deprecated4 = require("@clerk/shared/deprecated");
...
function signedInAuthObject(sessionClaims, options, debugData) {
  ...
  if (apiKey) {
    (0, import_deprecated4.deprecated)("apiKey", "Use `secretKey` instead.");
  }
...
var makeAuthObjectSerializable = (obj) => {
  const { debug, getToken, experimental__has, ...rest } = obj;
  return rest;
};
...
function loadInterstitialFromLocal(options) {
  ...
  if (options.pkgVersion) {
    (0, import_deprecated.deprecated)("pkgVersion", "Use `clerkJSVersion` instead.");
  }
  options.frontendApi = (0, import_keys.parsePublishableKey)(options.publishableKey)?.frontendApi || options.frontendApi || "";
  const domainOnlyInProd = !isDevOrStagingUrl(options.frontendApi) ? (0, import_url.addClerkPrefix)(options.domain) : "";
  const {
    debugData,
    frontendApi,
    pkgVersion,
    ...
    <body>
        <script>
            ...
            (() => {
                ...
                script.async = true;
                script.src = '${clerkJSUrl || (0, import_url.getScriptUrl)(proxyUrl || domainOnlyInProd || frontendApi, {
    pkgVersion,
    clerkJSVersion
  })}';
...
async function loadInterstitialFromBAPI(options) {
  ...
  const response = await (0, import_callWithRetry.callWithRetry)(
...
function buildPublicInterstitialUrl(options) {
  ...
  url.searchParams.append("clerk_js_version", clerkJSVersion || (0, import_url.getClerkJsMajorVersionOrTag)(frontendApi, pkgVersion));
  if (publishableKey) {
...
var import_deprecated5 = require("@clerk/shared/deprecated");
...
function decodeJwt(token) {
  ...
  (0, import_deprecated5.deprecatedObjectProperty)(
    payload,
    "orgs",
...
async function verifyJwt(token, { audience, authorizedParties, clockSkewInSeconds, clockSkewInMs, issuer, key }) {
  if (clockSkewInSeconds) {
    (0, import_deprecated.deprecated)("clockSkewInSeconds", "Use `clockSkewInMs` instead.");
  }
...
var nonBrowserRequestInDevRule = (options) => {
  ...
  const key = secretKey || apiKey || "";
  if ((0, import_keys.isDevelopmentFromApiKey)(key) && !isBrowser(userAgent)) {
...
var isPrimaryInDevAndRedirectsToSatellite = (options) => {
  ...
  const key = secretKey || apiKey || "";
  const isDev = (0, import_keys.isDevelopmentFromApiKey)(key);
...
var potentialFirstLoadInDevWhenUATMissing = (options) => {
  ...
  const key = secretKey || apiKey || "";
  const res = (0, import_keys.isDevelopmentFromApiKey)(key);
  if (res && !clientUat) {
...
var potentialRequestAfterSignInOrOutFromClerkHostedUiInDev = (options) => {
  ...
  const key = secretKey || apiKey || "";
  if ((0, import_keys.isDevelopmentFromApiKey)(key) && crossOriginReferrer) {
...
var potentialFirstRequestOnProductionEnvironment = (options) => {
  ...
  const key = secretKey || apiKey || "";
  if ((0, import_keys.isProductionFromApiKey)(key) && !clientUat && !cookieToken) {
...
function assertSignInUrlExists(signInUrl, key) {
  if (!signInUrl && (0, import_keys.isDevelopmentFromApiKey)(key)) {
...
async function authenticateRequest(options) {
  ...
  options = {
    ...
    frontendApi: (0, import_keys.parsePublishableKey)(options.publishableKey)?.frontendApi || options.frontendApi,
...
function redirect({ redirectAdapter, signUpUrl, signInUrl, frontendApi, publishableKey }) {
  if (!frontendApi) {
    frontendApi = (0, import_keys.parsePublishableKey)(publishableKey)?.frontendApi;
  } else {
    (0, import_deprecated.deprecated)("frontendApi", "Use `publishableKey` instead.");
  }
...
function Clerk(options) {
  ...
  (0, import_deprecated6.deprecatedObjectProperty)(
    clerkInstance,
    "__unstable_options",
