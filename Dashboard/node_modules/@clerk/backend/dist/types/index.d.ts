...
export declare function Clerk(options: ClerkOptions): {
    ...
    remotePublicInterstitial: ({ frontendApi: runtimeFrontendApi, publishableKey: runtimePublishableKey, proxyUrl: runtimeProxyUrl, isSatellite: runtimeIsSatellite, domain: runtimeDomain, userAgent: runtimeUserAgent, ...rest }: import("./tokens/interstitial").LoadInterstitialOptions) => Promise<string>;
    ...
    organizationRoles: import("./api/endpoints").OrganizationRoleAPI;
    organizationPermissions: import("./api/endpoints").OrganizationPermissionAPI;
