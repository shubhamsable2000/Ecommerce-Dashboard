 ...
 * @experimental
 */
export declare const Experimental__Gate: typeof import("./components.server").Experimental__Gate;
export declare const auth: () => (Omit<import("@clerk/backend").SignedInAuthObject, "session" | "user" | "organization"> & {
...
}) | (Omit<import("@clerk/backend").SignedOutAuthObject, "session" | "user" | "organization"> & {
    user: null;
    organization: null;
    session: null;
});
...
export declare const clerkClient: {
    ...
    organizationRoles: import("@clerk/backend/dist/types/api/endpoints").OrganizationRoleAPI;
    organizationPermissions: import("@clerk/backend/dist/types/api/endpoints").OrganizationPermissionAPI;
