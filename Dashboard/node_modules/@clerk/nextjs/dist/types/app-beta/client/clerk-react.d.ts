...
export declare const useAuth: () => {
    ...
    actor: import("@clerk/types").ActJWTClaim | null;
    orgId: string;
    orgRole: import("@clerk/types").MembershipRole;
    orgSlug: string | null;
    experimental__has: import("@clerk/types").experimental__CheckAuthorizationWithoutPermission;
    signOut: import("@clerk/types").SignOut;
    getToken: import("@clerk/types").GetToken;
};
/**
